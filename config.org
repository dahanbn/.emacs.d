...
#+BEGIN_SRC emacs-lisp
  (defun dh/open-my-current-taskfile ()
    "opens my current tasks orgfile"
    (interactive)
...
#+begin_src emacs-lisp
  ...
  (if (boundp 'dh/me-at-work)
      (defconst dh/location-for-frame-title (concat "@WORKING") "contains the wording if I am at work or not for the frame-title") ; true
    (defconst dh/location-for-frame-title (concat "@NOT AT WORKING") "contains the wording if I am at work or not for the frame-title") ; false
    )
...
#+BEGIN_SRC emacs-lisp
  (defhydra dh-hydra-info-help (:color blue
                                       :columns 3)
    "dh - useful info"
    ("S-<F1>" 'dh/open-my-init-file "open config.org")
