...
** some ignored file exqtensions for completions
#+begin_src emacs-lisp :tangle yes
  (push ".out" completion-ignored-extensions)
  (push ".pdf" completion-ignored-extensions)
  (push ".synctex.gz" completion-ignored-extensions)
...
#+begin_src emacs-lisp
  ...
  (when (boundp 'dh/dropbox-dir)
    ...
    (push `("tasks: org directory" . ,(expand-file-name "org" dh/dropbox-dir)) yal/launchable-items-emacs)
    (push `("tasks: 0-dh-tasks.org" . ,(expand-file-name "0-dh-tasks.org" dh/dropbox-dir)) yal/launchable-items-emacs)
    (push `("tasks: refile-beorg.org" . ,(expand-file-name "refile-beorg.org" dh/dropbox-dir)) yal/launchable-items-emacs)
    (push `("tasks: refile-drafts.org" . ,(expand-file-name "refile-drafts.org" dh/dropbox-dir)) yal/launchable-items-emacs)
    (push `("tasks: notes.org" . ,(expand-file-name "notes.org" dh/dropbox-dir)) yal/launchable-items-emacs)
    (push `("tasks: misc.org" . ,(expand-file-name "misc.org" dh/dropbox-dir)) yal/launchable-items-emacs)
    ...
    (when (file-directory-p (expand-file-name "dahan_text" dh/dropbox-dir))
  ...
  (when (and (boundp 'dh/dropbox-dir) (file-directory-p (expand-file-name "dahan_ebooks" dh/dropbox-dir)))
