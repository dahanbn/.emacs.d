...
#+begin_src emacs-lisp
  ...
  (when (boundp 'dh/me-at-work)
    ...
    (add-to-list 'sml/replacer-regexp-list '("^:I_DANIEL:Emacs/portable_emacs/.emacs.d/" ":ED:") t)
    (add-to-list 'sml/replacer-regexp-list '("^:I_DANIEL:Emacs/snippets-work/" ":WORKSNIPPETS:") t)
...
#+BEGIN_SRC emacs-lisp
  ...
  (cond
   ((find-font (font-spec :name "CamingoCode"))
    ...
    (set-face-attribute 'fixed-pitch nil :font "CamingoCode")
    (set-face-attribute 'fixed-pitch-serif nil :font "CamingoCode"))
...
** literate-calc-mode
Something like Tydlig or Soulver with Emacs calc.
...
#+begin_src emacs-lisp
  (use-package yasnippet
    ...
    (if (boundp 'dh/me-at-work)
        (push (expand-file-name "I:/DATEN/_Daniel/Emacs/snippets-work") yas-snippet-dirs))
