...
#+begin_src emacs-lisp
  (defun dh/format-as-euro (num)
    ...
    (let* ((size 3)
           (char ".")
           (str (replace-regexp-in-string "\\." "," ; replacing . with ,
                                          (if (stringp num)
                                              num
...
#+begin_src emacs-lisp
  ...
  (push '("elisp: Xah Elisp Tutorial - hashmpas" . "http://ergoemacs.org/emacs/elisp_hash_table.html") yal/launchable-items-url)
